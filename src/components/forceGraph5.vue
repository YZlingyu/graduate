 ...
 import axios from 'axios'
  export default {
    ...
    methods: {
      ...
      getEnterprises(e){
        axios.get("http://10.108.219.105:8080/database/neo4j/findCompanyByTechnology",{
          params:{
            technology : '经纬中国'
          },
          datatype:'jsonp',
          ...
          console.log(err);
           ...
           for(var enterprise in enterpriseList){
      ...
      getTechnologies(e){
        axios.get("http://10.108.219.105:8080s/database/neo4j/findTechnologyChildrens",{
          params:{
            technology : '经纬中国'
          },
          datatype:'jsonp',
