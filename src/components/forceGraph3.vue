...
<script>
  export default {
    ...
    mounted(){
      ...
      var nodes = [
        { "name": "基于深度学习的人脸识别安全系统"   , "type" : "1" },
        { "name": "一种基于人脸识别的系统设计与实现（成果）"   , "type" : "1" },
        { "name": ""   , "type" : "1" },
        { "name": ""   , "type" : "1" },
        { "name": ""   , "type" : "1" },
...
//添加连线
      ...
      var color = [
        {color:"#7C5053",label:"成果"},
        {color:"#6B1901",label:"技术链"},
        {color:"#B42A01",label:"专利"},
        {color:"#B45A2D",label:"机构"},
        {color:"#D9B318",label:"专家"}
      ];
...
//更新文字坐标
      ...
      for(var j=0; j<color.length;j++){
        tool += '<div class="circle1" style="width:10px; height:10px; border-radius:50px;background-color:'+color[j].color+';"></div><span class="label2">'+color[j].label+'</span>';
      }
